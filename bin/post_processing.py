...
def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(
        description="Post-process recorded satellite passes (copy, notify, DB import, plotting)",
        epilog="""
...
EXAMPLES:
  ...
  python3 post_processing.py --last 1 --copy --notify --db --plots

  # Re-process specific pass (only DB and plots)
  python3 post_processing.py --pass-id "2026-05-04_13-45-30_METEOR_M2-X" --db --plots

  # Batch process last 10 passes (copy only)
  python3 post_processing.py --last 10 --copy

  # Process by reception.json file
  python3 post_processing.py --reception-json /var/lib/satpi/output/.../reception.json --notify
        """,
